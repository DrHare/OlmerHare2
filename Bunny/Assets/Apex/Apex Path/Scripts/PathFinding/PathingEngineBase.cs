...
using UnityEngine;
    ...
    public abstract class PathingEngineBase : IPathingEngine
    {
        ...
        private bool StartRequest(IPathRequest request)
        {
            ...
            var start = request.fromGrid.GetCell(request.from, true) as IPathNode;
            ...
            if (!_goal.isWalkable(_currentRequest.requester.attributes) && !_currentRequest.navigateToNearestIfBlocked)
            {
